...
\newcommand{\xsectionx}[1]{
\multicolumn{8}{l}{}\\[-3pt]
\multicolumn{8}{l}{\bfseries\Large #1} \\
\hline
}
...
\xsectionx{16-Bit Transfer}
LD dd, nn & dd $\leftarrow$ nn & dd = BC, DE, HL, SP & 3 & \multirow{3}{*}{-} & \multirow{3}{*}{-} & \multirow{3}{*}{-} & \multirow{3}{*}{-} \\
\cline{1-4}
LD [nn], SP & [nn] $\leftarrow$ SP\textsubscript{L}, [nn$+1$] $\leftarrow$ SP\textsubscript{H} & & 5 & & & & \\
\cline{1-2} \cline{4-4}
...
CP s & A $-$ s & s = r, n, [HL] & & * & 1 & * & * \\
\cline{1-2} \cline{5-8}
AND s & A $\leftarrow$ A $\wedge$ s & \multicolumn{1}{|l|}{ \rdelim\}{3}{*}[ Bitwise operations] } & & * & 0 & 1 & 0 \\
\cline{1-2} \cline{5-8}
...
\cline{1-4}
JR e & PC $\leftarrow$ PC $+$ e & Base address is that & 3 & & & & \\
\cline{1-2} \cline{4-4}
JR cc, e & If cc is true, PC $\leftarrow$ PC $+$ e & of \emph{next} instruction & If cc is true, 3 else 2 & & & & \\
\hline

\xsectionx{Calls \& Returns}
CALL nn & [SP$-1$] $\leftarrow$ PC\textsubscript{H}, [SP$-2$] $\leftarrow$ PC\textsubscript{L}, \linebreak SP $\leftarrow$ SP$-2$, PC $\leftarrow$ nn & & 6 & \multirow{5}{*}{-} & \multirow{5}{*}{-} & \multirow{5}{*}{-} & \multirow{5}{*}{-} \\
\cline{1-2} \cline{4-4}
